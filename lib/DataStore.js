...
var DataStore = {
  ...
  "insertDeployment": function(userid, deploymentConfig) {
    return simpleQuery("INSERT INTO deployments SET ?", deploymentConfig.toDB());
  },

  "removeDeployment": function(userid, deploymentId) {
  ...
  "getDeployment": function(userid, id) {
    return simpleQuery("SELECT * FROM deployments WHERE owner = ? AND id = ?", [userid, id], DeploymentConfiguration, true);
  },
