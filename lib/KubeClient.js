...
var KubeClient = {
	...
	"update": function(object) {
		...
		if (typeEndpoints[object.kind]) {
			path = "namespaces/default/" + typeEndpoints[object.kind].path + '/' + object.metadata.name
  ...
  "create": function(object) {
	...
	"deleteDeployment": function(id) {
		return this.delete('namespaces/default/deployments/' + id, "v1beta1")
	},

	"deleteService": function(id) {
		return this.delete('namespaces/default/services/' + id, "v1")
	}
