...
var DeploymentManager = {
	...
	"create": function(application, deploymentConfig, log) {
		...
		.then(() => {
			console.log(" XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX XXXXXX ")
		})
		.catch((err) => {
			console.error(" ---- --- -- -- -- ")
			console.error(err)
		...
		.then(() => {
			...
			log.info({"deployment": deployment}, "Generated deployment")
			...
			return Promise.all(objectkeys.map((okey) => {
				log.info({"object": deployment.objects[okey], "key": key}, "About to deploy object")
